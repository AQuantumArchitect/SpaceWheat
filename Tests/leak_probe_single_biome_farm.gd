...
func _run() -> void:
	...
	for biome_name in ["Village", "BioticFlux", "StellarForges", "FungalNetworks", "VolcanicWorlds"]:
		state.unexplored_biome_pool.append(biome_name)
