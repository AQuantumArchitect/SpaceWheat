# itch.io Page — Draft Copy (owner review before publish)

Assets: `releases/store_kit/` — 7 screenshots + `tap_loop.gif` (22 frames).
...
empire measures its subjects into rigidity; your island survives by staying
*plural* — many modes coexisting, no single answer imposed. Whether your
island ends up rigid or free isn't decided by a dialogue tree. It's decided
by the spectral gap of the Hamiltonian you actually built. You can open the
microscope and check.
...
- A biome microscope that shows the honest numbers behind every field
...
1. `01_living_farm.png` — stations + metro lines (retake on release build)
2. `tap_loop.gif` — the pop moment (upload as cover-adjacent GIF)
3. `04_microscope.png` — "plural — many modes coexist"
4. `02_measured_mix.png` — live vs measured bubbles
5. `03_village.png` — the Village
6. `05_contracts.png` — contracts board
7. `07_ceremony_door.png` — "The door stays open."

## Cover image

The existing titlecard (`Assets/spacewheat_titlecard.png`) resized to
630×500 works as-is; it's the strongest single image the project has.
