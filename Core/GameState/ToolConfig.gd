	...
	FRAME_ICON: {
		...
		"actions": {
			"inject": {
				...
				"E": {"action": "inspect_qubit", "label": "Loops", "emoji": "🔍", "icon": "",
					  "hint": "Read this biome's loop card: frozen walks, Wilson cycles, β₁. Same ledger as Operator 🧭 E."},
	...
	FRAME_DRUID: {
		...
		"actions": {
			"X": {
				...
				"E": {"action": "hadamard", "label": "Superpose", "emoji": "H",
					  "icon": "res://Assets/UI/Q-Bit/Hadamard.svg",
					  "hint": "Superpose — spread the qubit across both poles (Hadamard)"},
